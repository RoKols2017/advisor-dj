...
class PrintEvent(models.Model):
    ...
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="print_events", verbose_name="Пользователь"
    )
    printer = models.ForeignKey(
        "printing.Printer", on_delete=models.CASCADE, related_name="print_events", verbose_name="Принтер"
    )
    ...
    computer = models.ForeignKey(
        Computer, on_delete=models.SET_NULL, null=True, related_name="print_events", verbose_name="Компьютер"
    )
    port = models.ForeignKey(
        Port, on_delete=models.SET_NULL, null=True, related_name="print_events", verbose_name="Порт"
    )
