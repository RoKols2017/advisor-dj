...
class Printer(models.Model):
    ...
    model = models.ForeignKey(
        PrinterModel, on_delete=models.PROTECT, related_name="printers", verbose_name="Модель принтера"
    )
    building = models.ForeignKey(
        "printing.Building", on_delete=models.PROTECT, related_name="printers", verbose_name="Здание"
    )
    department = models.ForeignKey(
        "printing.Department", on_delete=models.PROTECT, related_name="printers", verbose_name="Отдел"
    )
