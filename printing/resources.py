...
class PrinterResource(resources.ModelResource):
    model = fields.Field(column_name="model", attribute="model", widget=ForeignKeyWidget(PrinterModel, "code"))
    building = fields.Field(column_name="building", attribute="building", widget=ForeignKeyWidget(Building, "code"))
...
class PrintEventResource(resources.ModelResource):
    ...
    printer = fields.Field(column_name="printer", attribute="printer", widget=ForeignKeyWidget(Printer, "name"))
    computer = fields.Field(column_name="computer", attribute="computer", widget=ForeignKeyWidget(Computer, "name"))
    port = fields.Field(column_name="port", attribute="port", widget=ForeignKeyWidget(Port, "name"))
