...
class UserServiceTests(TestCase):
    ...
    def test_create_or_update_user_new_user(self):
        ...
        user, created = UserService.create_or_update_user(username="newuser", fio="New User", department_code="IT")
    ...
    def test_create_or_update_user_existing_user(self):
        ...
        user, created = UserService.create_or_update_user(username="existinguser", fio="Old Name", department_code="IT")
        self.assertTrue(created)

        # Обновляем пользователя
        updated_user, created = UserService.create_or_update_user(
            username="existinguser", fio="New Name", department_code="IT"
        )
    ...
    def test_create_or_update_user_new_department(self):
        ...
        user, created = UserService.create_or_update_user(
            username="user_with_new_dept", fio="User With New Dept", department_code="HR"
        )
    ...
    def test_get_user_by_username_existing(self):
        ...
        user = User.objects.create_user(username="testuser", fio="Test User", department=self.department)
