...
class UserImportFormTests(TestCase):
    ...
    def test_form_invalid_file_extension(self):
        ...
        txt_file = SimpleUploadedFile("test.txt", b"some content", content_type="text/plain")
    ...
    def test_form_process_file_invalid_csv(self):
        ...
        csv_file = SimpleUploadedFile("test.csv", invalid_content.encode("utf-8-sig"), content_type="text/csv")
    ...
    def test_form_process_file_update_existing_user(self):
        ...
        existing_user = User.objects.create_user(username="existinguser", fio="Old Name", department=self.department)
